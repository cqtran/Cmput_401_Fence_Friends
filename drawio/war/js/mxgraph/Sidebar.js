...
/**
 * Adds the fencing palette to the sidebar.
 */
Sidebar.prototype.addFencingPalette = function(dir)
{
	if (!dir) {
		dir = 'stencils';
	}

	this.addStencilPalette('fencing', 'Fencing', dir + '/fencing.xml',
		';whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;strokeWidth=2',
