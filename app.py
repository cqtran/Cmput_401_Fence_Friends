...
def setup_db():
    ...
    if not fieldExist(dbSession, Project.project_id, 1):
        newProject = Project(project_id = 1, customer_id = 1, status_name = "Not Reached",
                             address = "1234", start_date =  "2017-08-19")
